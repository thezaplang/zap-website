...
description: Build Zap from source, compile your first program, and learn where to go next.
---
...
1. Build the compiler from source by following [Installing from source](/guides/install_src/).
2. Compile the first example from [First Program](/guides/first_program/).
3. Continue with [Variables](/guides/declaring_variables/), [Functions](/guides/calling_functions/), and [Classes](/guides/classes/).
